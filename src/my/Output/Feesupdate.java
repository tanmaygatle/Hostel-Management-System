 ...
 * @author tanmay
 */
public class Feesupdate extends javax.swing.JFrame {
...
int sid;
    ...
    public Feesupdate(int sid,String fname,String lname) {
        initComponents();
        this.sid = sid;
        this.fname = fname;
        this.lname = lname;
    ...
    private void FillEverything() {
        ...
        try{
            ...
            rs = pst.executeQuery();
            if(rs.next()){
                txtfeestatus.setSelectedItem(rs.getString("fee_status"));
                SimpleDateFormat inputFormat=new SimpleDateFormat("MMMM-yyyy");
                java.util.Date d;
                d = inputFormat.parse(rs.getString("fee_month_year"));
                SimpleDateFormat outputFormat1=new SimpleDateFormat("yyyy");
                SimpleDateFormat outputFormat2=new SimpleDateFormat("MM");
                txtyear.setSelectedItem(outputFormat1.format(d));
                txtmonth.setSelectedItem(outputFormat2.format(d));
            }
            else{
    ...
    private void updatebuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updatebuttonActionPerformed
        // TODO add your handling code here:
        String sql = "update fee set fee_month_year = ? ,fee_status = ? where student_id = ?";
        try{
            pst = conn.prepareStatement(sql);
            SimpleDateFormat inputFormat=new SimpleDateFormat("yyyy-MM");
            java.util.Date d;
            ...
            if(n > 0){
                this.dispose();
                JOptionPane.showMessageDialog(null,"You have successfully updated fees for student " + sid);
            }
            else{
                JOptionPane.showMessageDialog(null,JOptionPane.ERROR_MESSAGE);
            }
   ...
   // public static void main(String args[]) {
       ...
       /* try {
            ...
            java.util.logging.Logger.getLogger(Feesupdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
